...
add_config() {
    ...
    HTTP_USERNAME=$(safe_read "请输入 HTTP 用户名" "$default_user")
    HTTP_PASSWORD=$(safe_read "请输入 HTTP 密码" "$default_pass")
